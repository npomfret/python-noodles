...
def plot_raw_prices(data_date, data_close_price, config, ticks_interval, num_data_points, symbol, display_date_range):
    # plot
...
def plot_train_vs_test(num_data_points, window_size, split_index, scaler, data_y_train, data_y_val, data_date, config, ticks_interval, symbol):
...
def plot_predictions_vs_actual(num_data_points, window_size, split_index, scaler, predicted_train, predicted_val, data_date, data_close_price, config, ticks_interval):
    # prepare data for plotting
...
def plot_predictions_vs_actual_zoomed(scaler, data_y_val, predicted_val, data_date, split_index, window_size, config, ticks_interval):
...
def plot_predict_unseen(scaler, data_y_val, predicted_val, prediction, data_date, config):
    # prepare plots
    plot_range = 10
